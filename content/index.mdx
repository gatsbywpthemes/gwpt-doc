...
- Install the free plugin <a href="https://wordpress.org/plugins/all-in-one-wp-migration/" target="_blank">All In One WP Migration</a>
...
- Configure your settings
  - Make sure the permalinks are in the right format: if they are in plain, switch to Post name <img src="https://i.imgur.com/GnIhOQ5.gif" width="600"/>
  - Go to Settings / reading and choose the number of posts per page in "Blog pages show at most"
  - make sure that "Discourage search engine from indexing this site" is checked ![](https://i.imgur.com/7gJYiSa.png)
- that's it!
