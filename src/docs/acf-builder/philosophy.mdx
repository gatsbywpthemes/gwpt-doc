...
This builder is barebones and can be plugged into any starter and styled there with tailwindcss.

Changing the JSX structure requires applying shadowing to the concerned layout.
