...
Now Abril Fatface and Lora (all specified variants) are loaded and available in your project. You still have to specify how you want to use them in the `configTypography.js` file :
