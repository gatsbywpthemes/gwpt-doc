...
Depending on the starter, you might have the possibility to set up the Gatsby Colors Theme via WordPress Customizer. If you prefer to define colors in your `.js` configuration file instead, please head to [link to add]()