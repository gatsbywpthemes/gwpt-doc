...
If your WordPress theme adds color settings via Customizer, the WordPress values override tha values from the `config.js` file. That means that you have to add `overrideWPColors: true` to your `config.js` file.
