...
description: How code highlighting works and how you can configure it
---

We thought you may sometimes blog about code, and we added support for block code highlighting by default. Under the hood, we use [Prism](https://prismjs.com/).
...
> Please note that line numbers will be added only to the snippets that have "Show line numbers" activated in your WordPress code block.

## Deactivate code highlighting

If you don't need code highlighting in your project, and you want to optimize your bundle size, you can deactivate. You will have to rename or remove the `ActivatePrism.js` file from your starter folder `src/@gatsbywpthemes/{theme-name}/utils`.
