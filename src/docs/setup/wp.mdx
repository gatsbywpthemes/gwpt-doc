...
Gatsby fetches the data from your WordPress website, which means your WordPress website requires some initial configuration to expose the data in the right format.
...
If you already have a WordPress website with some content you want to preserve, you will need to to set it up manually.
...
@todo -> animated gif or short video
